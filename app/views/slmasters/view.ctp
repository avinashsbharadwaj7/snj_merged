...
<table>
        <tr>
                <th><?php
                            ...
                            $view_fields = $view_fields[0]['Slmaster'];
                            //$view_fields_files = $view_fields[0]['Slfile'];
 ...
 <fieldset>  
  ...
  <legend>Additional Information</legend>
    <div class="lte_view"><?PHP $i = 0; ?>
        ...
        <div <?php if ($i++ % 2 == 0) echo $class;?>>    
            <div class="view_col_left"><?php __('File Name(s)'); ?></div>
            <div class="view_col_right"><?php 
           // var_dump($view_fields[0]['Slmaster']);
            for($i = 0; $i < count($fileNames['Slfile']); $i++) 
             {
                if (isset($fileNames['Slfile'][$i]['file_name']))
                {
                echo ($i+1).')'.'  '.$fileNames['Slfile'][$i]['file_name']; ?>
                <br/>
                <?php  echo $this->Html->link(__('Download File', true), array('action' => 'download', $fileNames['Slfile'][$i]['file_name'])); ?>
                <br/>
             <?php   }
            } ?>
            </div>
