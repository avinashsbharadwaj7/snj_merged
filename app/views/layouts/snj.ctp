...
<head>	
	...
	<title>
		...
		<?php echo $javascript->link(array(
			'snj/jquery-1.7.2.min',
	        'snj/jquery-ui-1.8.20.custom.min',
	        'snj/i18n/grid.locale-en',
	        'snj/jquery.jqGrid.min',
			'jscalendar/jscal2', 
			'jscalendar/lang/en' 
			/*'jquery-1.3.2.min.js' ,
			'Highcharts/js/highcharts.js',
			'Highcharts/js/themes/gray.js',
        ...
        <?php echo $html->css('snj/960', 'stylesheet')."\n"; ?>
        <?php echo $html->css('snj/redmond/jquery-ui-1.8.20.custom', 'stylesheet')."\n"; ?>
        <?php echo $html->css('snj/ui.jqgrid', 'stylesheet')."\n"; ?>
        <?php
