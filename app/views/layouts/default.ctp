...
<head>	
	...
	<title>
		...
		<?php echo $javascript->link(array('jscalendar/jscal2', 'jscalendar/lang/en', 'jquery-1.3.2.min.js' ,'Highcharts/js/highcharts.js','Highcharts/js/themes/gray.js','Highcharts/js/modules/exporting.js','sladd_modify.js','sl.js','slpremodify_view.js','slpresearch.js','graphs.js','ntp.js','tac.js','noc.js', 'lte_add_modify.js','irtcm_filter.js','pqrfeedback.js')); ?>
...
<div id="container">
    <div id="inner_container">
        <div id="outer_header">
            <div id="header">
                <div id="sitename"><?php echo $html->link('PQR - SnJ', '/snjs/snjcall'); ?></div>
		<div id="mast"><?php
                                    if (Authsome::get()) {
