...
//                                );
echo "</fieldset>";
echo $ajax->div('pre_launch_report_placeholder', array('class'=>'formfields'));
echo $ajax->divEnd('pre_launch_report_placeholder');
echo $ajax->div('post_launch_report_placeholder', array('class'=>'formfields'));
echo $ajax->divEnd('post_launch_report_placeholder');
echo $ajax->observeField('RfModuleProjectType', array('update'=>'pre_launch_report_placeholder',
