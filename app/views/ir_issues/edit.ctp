...
<?php echo $this->Form->create('IrIssue');?>
	<fieldset>
		<legend><?php __('Edit Ir Issue'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('IrIssue.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('IrIssue.id'))); ?></li>
