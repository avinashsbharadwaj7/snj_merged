...
<?php                   
                            $final = $view_fields['Cakefeedback']; 
                            $final_comment = $view_fields['Cakefeedbackcomment']; 
?>
    ...
    <div class="lte_view"><?PHP $i = 0; ?>
		...
		<div <?php if ($i++ % 2 == 0) echo $class;?>>    
            <div class="view_col_left"><?php __('Feedback/Request'); ?></div>
			 <?php $final['notes'] = str_replace(' ', '&nbsp;',$final['notes']);
               $final['notes'] = nl2br($final['notes']); ?>
				...
				<legend>Comments</legend>				
						<?php foreach($final_comment as $comm): ?>
							<div <?php if ($i++ % 2 == 0) echo $class;?>>    
								...
								<?php $comm['comments'] = str_replace(' ', '&nbsp;',$comm['comments']);
								$comm['comments'] = nl2br($comm['comments']); ?>
