...
<?php if($dataValues['signum']==Authsome::get('username')){
    echo '&nbsp;|&nbsp; ';
    echo $this->Html->link(__('Edit',true),array('action'=>'edit',$dataValues['id'],true));
}?>
...
<div class="lte_container">
    ...
    <fieldset>
        <legend>Uploaded File Information</legend>
    
        <div class="lte_view"><?PHP $i = 0; ?>
            <div <?php if ($i++ % 2 == 0)
                    echo $class; ?>>    
                <div class="view_col_left_pd"><?php __('File'); ?></div>
                <?php
